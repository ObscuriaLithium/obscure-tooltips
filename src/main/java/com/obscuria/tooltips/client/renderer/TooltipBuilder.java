...
public final class TooltipBuilder {
    ...
    public static boolean build(TooltipRenderer renderer, ItemStack stack, Font font, List<ClientTooltipComponent> components, int x, int y, ClientTooltipPositioner positioner) {
        updateStyle(stack);
    ...
    private static void renderText(TooltipRenderer renderer, Font font, List<ClientTooltipComponent> components, Vec2 pos) {
    ...
    private static void renderImages(TooltipRenderer renderer, Font font, List<ClientTooltipComponent> components, Vec2 pos) {
    ...
    private static void renderStand(TooltipRenderer renderer, Vec2 pos) {
