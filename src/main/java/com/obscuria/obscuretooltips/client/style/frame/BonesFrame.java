...
public class BonesFrame implements TooltipFrame {
    ...
    public void render(GuiGraphics context, Vec2 pos, Point size, float seconds) {
        ...
        final float timeOffset = 2f + (float) Math.cos(seconds) * 6f;
        final float rotation1 = (float) Math.cos(seconds * 1.3f + timeOffset) * 0.2f;
        final float rotation2 = (float) Math.cos(seconds * 1.3f + 0.5f + timeOffset) * 0.2f;
        final float rotation3 = (float) Math.cos(seconds * 1.3f + 1f + timeOffset) * 0.2f;

        context.pose().pushPose();
        context.pose().translate(0, 0, 410);
        ...
        TooltipUtils.pushAndMul(context, Axis.ZP.rotation(rotation3),
                () -> context.pose().translate(x + width / 2f - 16f, y - 1f, 0f),
                () -> context.blit(DECOR, -3, -3, 11, 6, 3, 3, 80, 32));
        TooltipUtils.pushAndMul(context, Axis.ZP.rotation(rotation2),
                () -> context.pose().translate(x + width / 2f - 11f, y - 1f, 0f),
                () -> context.blit(DECOR, -6, -5, 14, 4, 6, 5, 80, 32));
        TooltipUtils.pushAndMul(context, Axis.ZP.rotation(rotation1),
                () -> context.pose().translate(x + width / 2f - 4f, y - 1f, 0f),
                () -> context.blit(DECOR, -9, -7, 20, 2, 9, 7, 80, 32));
        TooltipUtils.pushAndMul(context, Axis.ZP.rotation(-rotation3),
                () -> context.pose().translate(x + width / 2f + 17f, y - 1f, 0f),
                () -> context.blit(DECOR, 0, -3, 65, 6, 3, 3, 80, 32));
        TooltipUtils.pushAndMul(context, Axis.ZP.rotation(-rotation2),
                () -> context.pose().translate(x + width / 2f + 12f, y - 1f, 0f),
                () -> context.blit(DECOR, 0, -5, 59, 4, 6, 5, 80, 32));
        TooltipUtils.pushAndMul(context, Axis.ZP.rotation(-rotation1),
                () -> context.pose().translate(x + width / 2f + 5f, y - 1f, 0f),
                () -> context.blit(DECOR, 0, -7, 50, 2, 9, 7, 80, 32));

        context.blit(DECOR, x + width / 2 - 1, y + height + 2, 38, 24, 3, 4, 80, 32);
        TooltipUtils.pushAndMul(context, Axis.ZP.rotation(-rotation3),
                () -> context.pose().translate(x + width / 2f - 12f, y + height + 1f, 0f),
                () -> context.blit(DECOR, -3, 0, 21, 23, 3, 3, 80, 32));
        TooltipUtils.pushAndMul(context, Axis.ZP.rotation(-rotation2),
                () -> context.pose().translate(x + width / 2f - 7f, y + height + 1f, 0f),
                () -> context.blit(DECOR, -6, 0, 24, 23, 6, 5, 80, 32));
        TooltipUtils.pushAndMul(context, Axis.ZP.rotation(-rotation1),
                () -> context.pose().translate(x + width / 2f - 1f, y + height + 1f, 0f),
                () -> context.blit(DECOR, -8, 0, 30, 23, 8, 7, 80, 32));
        TooltipUtils.pushAndMul(context, Axis.ZP.rotation(rotation3),
                () -> context.pose().translate(x + width / 2f + 13f, y + height + 1f, 0f),
                () -> context.blit(DECOR, 0, 0, 55, 23, 3, 3, 80, 32));
        TooltipUtils.pushAndMul(context, Axis.ZP.rotation(rotation2),
                () -> context.pose().translate(x + width / 2f + 8f, y + height + 1f, 0f),
                () -> context.blit(DECOR, 0, 0, 49, 23, 6, 5, 80, 32));
        TooltipUtils.pushAndMul(context, Axis.ZP.rotation(rotation1),
                () -> context.pose().translate(x + width / 2f + 2f, y + height + 1f, 0f),
